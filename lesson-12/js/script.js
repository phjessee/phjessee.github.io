...
const forecastURL = 'https://api.openweathermap.org/data/2.5/forecast?lat=20.4230&lon=-86.9223&units=imperial&appid=e592e2e06eeae47ff9c02cce63ec9adc';
fetch(forecastURL)
...
const apiURL = 'https://api.openweathermap.org/data/2.5/weather?lat=20.4230&lon=86.9223&appid=e592e2e06eeae47ff9c02cce63ec9adc&units=imperial';
fetch(apiURL)
  .then((response) => response.json())
  .then((jsObject) => {
